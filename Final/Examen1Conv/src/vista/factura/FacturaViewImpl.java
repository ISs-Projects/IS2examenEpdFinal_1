...
public class FacturaViewImpl extends AbstractViewImpl<FacturaController> implements FacturaView {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jTextFieldFecha, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
        );
    ...
    private void jButtonFiltrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonFiltrarActionPerformed
        ...
        List<Factura> facturas=getController().listarFacturaEntidadPorAnyoGesture(fecha);
    ...
    protected void fireNuevaFacturaGesture(String identificador, Cliente cliente, String importe,String fechaPago) {
    ...
    protected void fireActualizaFacturaGesture(String identificador, Cliente cliente, String importe, String fechaPago) {
        List<Serializable> datos = new ArrayList<Serializable>();
        datos.add(identificador);
        datos.add(cliente);
        datos.add(importe);
